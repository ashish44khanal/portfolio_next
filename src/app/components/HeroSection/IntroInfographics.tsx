  ...
  return (
    <div>
      <div className="flex items-center lg:gap-6">
        <div className="relative w-[65%] lg:w-full lg:rounded-lg h-80 overflow-hidden p-4 xl:p-8 dark:bg-gray-800">
          {/* Background image layer */}
          <div className="absolute inset-0 bg-[url('/workCardBg.jpg')] bg-cover bg-no-repeat mix-blend-multiply opacity-90 pointer-events-none"></div>
          <div>
        ...
        <div className="lg:w-full lg:rounded-lg h-80 fill-background">
          <img
            src="/ASK.png"
            alt="Aashish Khanal"
      ...
      <div className="flex flex-col flex-col-reverse lg:flex-row lg:items-center gap-4 lg:mt-6 p-4 lg:p-0">
        <div className="relative w-full lg:w-[70%] h-28 px-4 py-2 rounded-lg bg-gray-700 overflow-hidden">
          {/* Background image layer */}
          <div className="absolute inset-0 bg-[url('/workCardBg.jpg')] bg-cover bg-no-repeat mix-blend-multiply opacity-90 pointer-events-none"></div>
          ...
          <h1 className="text-2xl font-serif font-bold mt-2 leading-tight">
            <Link
              href={
                "https://svelte.dev/blog/whats-new-in-svelte-may-2025?ref=dailydev"
              }
              target="_blank"
        ...
        <div className="w-full lg:w-[30%] grid grid-cols-6 lg:grid-cols-3 gap-x-4 gap-y-4">
          {[
            RiTailwindCssFill,
            RiNextjsFill,
            SiNestjs,
            ...
            <div
              key={idx}
              className="relative p-2 rounded-lg mx-auto w-12 h-12"
            >
              {/* Glass background */}
